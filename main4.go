...
func main() {
	...
	router.HandleFunc("/api/AllList", getGames)
	router.HandleFunc("/api/item/{id}", getGame)
	router.HandleFunc("/api/del/{id}", deleteGame)
	router.HandleFunc("/api/update", updateGame)
	router.HandleFunc("/api/add", addGame)
	http.ListenAndServe(":3333", router)

	fmt.Println("http://localhost:3333/api/AllList")
	fmt.Println("http://localhost:3333/api/item/1")
	fmt.Println("http://localhost:3333/api/del/1")
